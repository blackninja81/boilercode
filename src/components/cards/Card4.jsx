...
import cardStyle from './card4.module.scss'

const Card4 = () => {
  return (
    <div className={cardStyle.main_card}>
      <div className={cardStyle.container}>
  <p className={cardStyle.container_title}>Here are the features<br/>we’re proud of</p>

  <div className={cardStyle.gradient_cards}>
    <div className={cardStyle.card}>
      <div className={`${cardStyle.container_card} ${cardStyle.bg_green_box}`}>
        ...
        <p className={cardStyle.card_title}>Zero-cost Possibilities</p>
        <p className={cardStyle.card_description}>Hubble lets users borrow USDH for a one-time 0.5% fee. No variable rates. No interest charged, ever.</p>
      </div>
    </div>

    <div className={cardStyle.card}>
    <div className={`${cardStyle.container_card} ${cardStyle.bg_white_box}`}>
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className={cardStyle.card_title}>Multi-Asset Collateral</p>
        <p className={cardStyle.card_description}>Deposit a variety of assets on Hubble, raise your collateral ratio, and unlock the liquidity in your wallet.</p>
      </div>
    </div>

    <div className={cardStyle.card}>
    <div className={`${cardStyle.container_card} ${cardStyle.bg_yellow_box}`}>
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className={cardStyle.card_title}>Get Yield on Deposits</p>
        <p className={cardStyle.card_description}>While your collateral is deposited, delegate it to earn the highest yield available in the Solana ecosystem.</p>
      </div>
    </div>

    <div className={cardStyle.card}>
    <div className={`${cardStyle.container_card} ${cardStyle.bg_blue_box}`}>
        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className={cardStyle.card_title}>Get up to 11x Leverage</p>
        <p className={cardStyle.card_description}>Hubble’s capital-efficient 110% collateral ratio lets users leverage up to 11x on their deposits.</p>
      </div>
    </div>
  </div>
</div>  
